...
const updatePlayerSession = (sessionId: ID, playerId: ID, payload: { paid?: boolean, attendance?: boolean }): Promise<void> => {
  return axios.put(`${SESSION_PLAYER_URL}/${sessionId}/players/${playerId}`, payload)
}

export { getPlayers, deletePlayer, assignPlayerToSession, updatePlayerSession }
